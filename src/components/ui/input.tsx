  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full rounded-md border border-input bg-background/80 px-6 py-2 text-base shadow-inner",
          ...
          "transition-colors duration-200 md:text-sm backdrop-blur-sm",
          className
        )}
        ref={ref}
        {...props}
